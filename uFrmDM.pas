...
//== Preenche Tabela Humor
  ...
  begin
    FDConnAfetivograma.ExecSQL('INSERT INTO HUMOR(HUMOR_ID, HUMOR_DESC) VALUES(1,"EUFORIA / AGITAÇÃO / ACELERAÇÃO / AGRESSIVIDADE")');
    FDConnAfetivograma.ExecSQL('INSERT INTO HUMOR(HUMOR_ID, HUMOR_DESC) VALUES(2,"IRRITBILIDADE / INQUIETAÇÃO / IMPACIÊNCIA")');
    FDConnAfetivograma.ExecSQL('INSERT INTO HUMOR(HUMOR_ID, HUMOR_DESC) VALUES(3,"BOM HUMOR / ESTABILIDADE / NORMALIDADE")');
    FDConnAfetivograma.ExecSQL('INSERT INTO HUMOR(HUMOR_ID, HUMOR_DESC) VALUES(4,"TRISTEZA / FADIGA / CANSAÇO / DESÂNIMO")');
    FDConnAfetivograma.ExecSQL('INSERT INTO HUMOR(HUMOR_ID, HUMOR_DESC) VALUES(5,"TRISTEZA PROFUNDA / LENTIDÃO / APATIA")');
  end;
//==
